...
`committer_date` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INDEX `repos_id,status` (`repos_id` ASC, `status` ASC)
)
ENGINE = InnoDB
AUTO_INCREMENT = 0
DEFAULT CHARACTER SET = utf8mb4
...
PRIMARY KEY (`id`) ,
UNIQUE INDEX `email,start_date,tag` (`email` ASC, `start_date` ASC, `tag` ASC)
)
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
...
`domain` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'NULL',
`added` bigint(20) UNSIGNED NOT NULL,
INDEX `type,projects_id` (`type` ASC, `projects_id` ASC)
)
ENGINE = InnoDB
AUTO_INCREMENT = 0
DEFAULT CHARACTER SET = utf8mb4
